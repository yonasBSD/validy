...
pub fn validate(value: &bool, field: &str, context: &bool) -> Result<(), ValidationError> {
	if !*value || !*context {
...
pub fn custom_params_two(value: &bool, field: &str, context: &bool, extra_param: &bool) -> Result<(), ValidationError> {
