...
#[validate(context = Arc<dyn MockedService>, payload, axum, multipart)]
...
pub struct TestDTO {
	...
	#[special(nested(RoleDTO, RoleDTO))]
...
fn validate_unique_email(email: &str, field: &str, service: &Arc<dyn MockedService>) -> Result<(), ValidationError> {
