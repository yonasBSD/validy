...
fn parse(value: String, _field: &str, context: &bool) -> ParseResult<u32> {
	if *context {
...
fn parse_two(value: String, _field: &str, context: &bool, extra_arg: &Option<u32>) -> ParseResult<u32> {
	if *context {
...
fn parse_three(_: String, field: &str, _context: &bool, a: &Option<u32>, b: &Option<u32>) -> ParseResult<u32> {
	match (a, b) {
		(_, None) => (
			0,
