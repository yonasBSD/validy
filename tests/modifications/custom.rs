...
struct Test {
	...
	pub a: String,
	#[modify(custom(modify_two, [&wrapper.a]))]
	pub b: Option<String>,
	#[modify(custom(modify_three, [&wrapper.a, &wrapper.b]))]
	pub c: Option<String>,
}

fn modify(value: &str, _field_name: &str) -> (String, Option<ValidationError>) {
	(value.to_string() + "_test", None)
}

fn modify_two(value: &str, _field_name: &str, extra_arg: &Option<String>) -> (String, Option<ValidationError>) {
